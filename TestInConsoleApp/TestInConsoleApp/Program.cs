...
namespace TestInConsoleApp
{
    class Program
    {
        ...
        {
            var test = new QuadTree_Intersect();
            Node node1=new Node();
            ...
            node2.topRight.bottomRight = new Node(true, true, null, null, null, null);
            node2.topRight.bottomLeft = new Node(true, true, null, null, null, null);
